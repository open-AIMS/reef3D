...
def batchNet(rootdir,summary_file, camType, proj_dir='projects', export_path='exports'):
    ''''
    ...
    with open(os.path.join(rootdir,'data/LTMP/summary_samples',summary_file), newline='', encoding='utf-8') as f:
